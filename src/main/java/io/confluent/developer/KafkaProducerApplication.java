...
//    takes a string, parses it for key & value and sends it to the broker
...
//    Takes file name and returns the Properties in the file.
...
//
    ...
    public static void main(String[] args) throws Exception {
        if(args.length<2) {
            throw new IllegalArgumentException("This program takes two arguments: the path to an environment configuration file and\" +\n" +
